...
from comenetf1_only_absorber import ComENetF1_Only_Absorber
...
model = ComENetF1_Only_Absorber(out_channels=npt,cutoff=cutoff,num_layers=3,hidden_channels=256,middle_channels=64,num_output_layers=3,num_radial=3,num_spherical=2)
