...
##########
##########BASIC
setting_prefix="FeIHS1_stableint"#using in class | function
setting_R=5.0
setting_Nsite=24
setting_Nstruct=200
...
##########TRAIN
setting_n_ep=1000#1000
setting_n_ep_save=200
setting_cutoff=8.0
# setting_npt=210;#245-35=210
setting_batch_size=32;setting_vt_batch_size=32;
setting_n_train=5452#25361#180*24  # 25361 test3176 valid3189
setting_n_valid=682#3189#20*24
##########FITTING
setting_npar=168
