...
##########ComENet  END
setting_prefix="Fe3O4_7114_17_21_39_npt120_-19_100_site"
setting_fmodel_begin="begin_256_3_0.0005_5_2_82_5.pt"
setting_n_ep=20
setting_ndata_finetune=500
...
dataset = train("train");
dataset=dataset[:setting_ndata_finetune];
...
def f(params,irun,str_save):
    ...
    model.load_state_dict( torch.load(setting_fmodel_begin) )
    ...
    print("Valid MAE before finetune:",valid_mae)
